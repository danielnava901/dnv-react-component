...
class All extends Component<any, any> {
  ...
  render() {
    const step = [{ caption: 'uni' }, { caption: 'dos' }];

    const data: Array<any> = [
      {
        loan_id: '25',
        created_at: '2020-02-13 18:41:28',
        days: '9',
        require_amount: '120000.00',
        title: 'Titulazo',
        description: 'Nada nada, siguele',
        pointed: '1',
        point_balance: '28',
        status: '1',
        term: '12',
        credit_destination_name: null,
        username: 'rober1',
        names: 'isaelasd',
        lastname_first: 'Barrera',
        lastname_second: 'Barrera',
        curp: 'dadsda',
        rfc: 'qqwqw',
        city: 'Chilpancingo',
        state: 'Guarrero',
        colony: 'guerrero',
        street: 'Blvd. Vicente Guerrero  Km 270, guerrero, guerrero',
        postal_code: '39010',
